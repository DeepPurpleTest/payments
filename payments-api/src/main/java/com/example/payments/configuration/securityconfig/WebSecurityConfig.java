...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .requestMatchers(HttpMethod.GET, "/card").hasAnyAuthority(clientAuthority)
                ...
                .requestMatchers(HttpMethod.PATCH, "/card/block").hasAnyAuthority(adminAuthority, clientAuthority)
                .requestMatchers(HttpMethod.PATCH, "/card/unlock").hasAnyAuthority(adminAuthority)
                .requestMatchers(HttpMethod.DELETE, "/card").hasAnyAuthority(clientAuthority)
